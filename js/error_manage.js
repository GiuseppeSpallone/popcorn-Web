...
//TO DO non funge vedi form film!
    ...
    $("form#login-form").on("submit", function () {
        ...
        $.ajax({
            ...
            success: function (esito) {
                if (esito.includes("user")) {
                   //$("div#user").modal('show');
                    window.location.href = "index.php?logged=user";

                } else if(esito.includes("admin")){
                   // $("div#admin").modal('show');
                    window.location.href = "index.php?logged=admin";
                }else{
    ...
    $("form#acquista").on("submit", function () {
        var data = $(this).serialize();
        $.ajax({
            type: "POST",
            url: "check/acquista.php",
            data: data,
            dataType: "html",
            success: function (esito) {
                if (esito == "ok") {
